            ...
            Actions\Action::make('make_repayment')
                ...
                ->action(function (array $data): void {
                    ...
                    try {
                        ...
                        $this->refreshInfolist();
                        $this->dispatch('refreshTransactions');
                        $installment = min((float) ($loan->installment_amount ?? $loan->monthly_payment), (float) $loan->fresh()->outstanding_balance + (float) ($loan->installment_amount ?? $loan->monthly_payment));
                        Notification::make()
